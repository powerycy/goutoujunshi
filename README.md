...
项目内置20份核心知识文档和20份实用沟通资料，另有6份前向测试场景规范。知识与实用资料覆盖：
...
| 日期 | 类型 | 更新 | 用户价值 |
| --- | --- | --- | --- |
| 2026-07-23 | 优化 | 将行为内核压缩为显式的1–3份参考路由，新增经典社交体系的机制分析、伦理能力转译与回归场景。 | 日常上下文成本保守估算降低 48.3%，同时让冷读、自然流、Blueprint 与 Mystery 类问题有明确的证据和安全边界。 |
