...
> **GOAI 2026 比赛分支**：`feat/goai-boundless-agent` 增加“关系决策实验室”桌面 Web Demo。评委可用公开合成案例，在无需 API Key 的情况下走完“证据趋势 → 事实/推断/未知 → 目标方案 → 人工确认 → 观察与停止条件”的闭环。比赛版本位于 [`demo/`](demo/README.md)，不改动主干发布版本。
