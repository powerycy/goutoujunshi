...
| 日期 | 类型 | 更新 | 用户价值 |
| --- | --- | --- | --- |
| 2026-07-22 | 扩充 | 调研 GitHub 上的童锦程、梵公子及关系副驾类 Skill，新增七种主策略、三层话术编排、36 条可改写话术骨架和对话演练模式。 | 用户问“这句怎么回”时先得到一条真正能发的首选成品，并能按积极、含糊或拒绝反应继续。 |
| 2026-07-22 | 新增 | 从童锦程与梵公子的公开内容中提炼展示面、现场取材、对话接抛、轻松调情、分级推进和即时校准，并新增 9 个测试场景。 | 在不模仿人设或照搬套路的前提下，生成更松弛、有趣、能根据对方反馈进退的实用策略。 |
