...
> **GOAI 2026 比赛分支**：截至参赛时，狗头军师全网相关内容累计 **100W+ 观看、1000+ 评论**。`feat/goai-boundless-agent` 增加“关系 K 线图”桌面 Web Demo：回看互动历史与当前趋势，评估未来推进可能性，回答“这段关系还能不能推进、下一步具体做什么”。评委可用公开合成案例，无需 API Key 走完完整决策闭环。比赛版本位于 [`demo/`](demo/README.md)，只保留在独立分支与 Draft PR，不合并主干。
